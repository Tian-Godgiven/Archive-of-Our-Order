<template>
  <div class="h-screen flex flex-col bg-gray-50">
    <!-- 顶部栏 -->
    <div class="bg-white shadow-sm px-4 z-10 shrink-0" style="padding-top: env(safe-area-inset-top)">
      <div class="flex items-center justify-between max-w-md mx-auto py-4">
    ...
    <!-- 成员筛选栏 -->
    <div class="bg-white p-4 shadow-sm overflow-x-auto touch-pan-x shrink-0">
